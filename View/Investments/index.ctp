<div class="investments index">
	...
	<tr>
		...
		<td><?php echo h($investment['Investment']['amount']); ?>&nbsp;</td>
		<td><?php echo h($investment['Investment']['comment']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $investment['Investment']['id']), null, __('Are you sure you want to delete # %s?', $investment['Investment']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
